...
class _ProductState extends State<Product> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final int totalQty = cartProvider.cartItems.fold(0, (sum, item) => sum + item.quantity);
    ...
    final int crossAxisCount = screenWidth > 1200 ? 5 : (screenWidth > 900 ? 4 : (isWideScreen ? 3 : 2));
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -80,
            left: screenWidth > 1200 ? screenWidth / 2 - 600 : (screenWidth > 800 ? screenWidth / 2 - 400 : -60),
            child: _buildCircle(260, 0.09),
          ),
          Positioned(
            top: -40,
            right: screenWidth > 1200 ? screenWidth / 2 - 550 : (screenWidth > 800 ? screenWidth / 2 - 350 : -80),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset("assets/images/Herblogo.png", height: (screenWidth * 0.08).clamp(30.0, 40.0)),
                          const Spacer(),
                          _buildHeaderButton(
                          ...
                          _buildHeaderButton(
                            ...
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => Info(authProvider.userId))),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.search_rounded, color: Color(0xFF43A047)),
                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  const Text("My Cart", style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.w500)),
                                  Text("Points: ${totalPoint.toStringAsFixed(2)}", style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
                                ],
                              ),
                              const Spacer(),
                              const Padding(
                                padding: EdgeInsets.only(right: 18),
                                child: Icon(Icons.arrow_forward_ios_rounded, color: Colors.white70, size: 16),
                              ),
                            ],
                          ),
                        ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Container(width: 4, height: 16, decoration: BoxDecoration(color: kPrimaryGreen, borderRadius: BorderRadius.circular(2))),
                          const SizedBox(width: 8),
                          Text(
                          ...
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("No products found", style: TextStyle(fontSize: 15, color: Colors.grey.shade400, fontWeight: FontWeight.w500)),
                                ],
                              ),
                            )
                          : GridView.builder(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: color == Colors.white ? Colors.black.withValues(alpha: 0.06) : color.withValues(alpha: 0.25),
              blurRadius: 8,
  ...
  void flyToCart(GlobalKey itemKey, String imagePath) {
    if (itemKey.currentContext == null || cartKey.currentContext == null) return;
  ...
  void _runFlyAnimation(Offset start, Offset end, String imagePath) {
    final animController = AnimationController(duration: const Duration(milliseconds: 600), vsync: this);
    final posAnimation = Tween<Offset>(begin: start, end: end).animate(CurvedAnimation(parent: animController, curve: Curves.easeInOut));
    final sizeAnimation = Tween<double>(begin: 80, end: 10).animate(CurvedAnimation(parent: animController, curve: Curves.easeInOut));
      ...
      builder: (context) => AnimatedBuilder(
        ...
        builder: (context, child) {
          return Positioned(
            ...
            child: Image.asset(imagePath, width: sizeAnimation.value, height: sizeAnimation.value),
          );
        },
      ),
    );
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Text('Items Saved in Cart', style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          actions: <Widget>[
            TextButton(
              child: const Text('Understood', style: TextStyle(color: Color(0xFF1B5E20), fontWeight: FontWeight.bold)),
